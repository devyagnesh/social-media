...
<body>
    ...
    $_SESSION["Second_Stage"] = (int)1;
    if ((isset($_SESSION["Second_Stage"]) && $_SESSION["Second_Stage"] === 1) && (isset($_GET["Hash"]) && $_GET["Hash"] === $_SESSION["hash"])) {
        $UserIdObj = new View();
        ...
        if ($CountRow === 1) {
            header("Location: ../Step2/SecurityQuetions.php?Hash=" . $_SESSION["SqHash"]);
            exit();
        } else {
    ?>
                ...
                <div class="step-1-wrapper">
                    <div class="main-profile-wrapper">
                        <div class="profile-image">
                            <img src="profile_image/male.png" alt="" />
                        </div>
                        ...
                        <div class="profile_update_button">
                            <form action="../steps_backend/set_profile.php" method="post" enctype="multipart/form-data">
